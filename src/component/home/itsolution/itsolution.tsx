                ...
                <div className="swiper-container hero-slider__container">
                    <div className="swiper-wrapper">
                        <div className="swiper-slide">
                            <div className="hero-wrapper resolutions-hero-space resolutions-hero-bg" data-swiper-autoplay="5000">
                                            ...
                                            <div className="col-lg-12 col-md-12 m-auto">
                                                <div className="service-hero-wrap wow move-up">
                                                    <div className="service-hero-text text-center">
                                                        <h3 className="text-white">IT Services Designed For</h3>
                                                        <h1 className="font-weight--reguler text-white mb-30">Your Business</h1>
                                                        ...
                                                        <div className="hero-button-group section-space--mt_50">
                                                            <a   className="ht-btn ht-btn-md">Free consultation</a>
                                                            <a   className="ht-btn ht-btn-md btn--white"><span className="btn-icon me-2"><i className="fa fa-play"></i></span> How we work</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div className="swiper-slide">
                            <div className="hero-wrapper resolutions-hero-space resolutions-hero-bg-2" data-swiper-autoplay="5000">
                                <div className="resolutions-hero-area-content">
                                    <div className="container">
                                        <div className="row">
                                            <div className="col-lg-12 col-md-12 m-auto">
                                                <div className="service-hero-wrap wow move-up">
                                                    <div className="service-hero-text text-center">
                                                        <h3 className="text-white">IT Services Designed For</h3>
                                                        <h1 className="font-weight--reguler text-white mb-30">Your Company</h1>
                                                        <p className="text-white">Highly Tailored IT Design, Management & Support Services.</p>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-12">
                                            ...
                                            <div className="image-box-wrap">
                                                <div className="box-image">
                                                    <div className="default-image">
                                                        <img className="img-fulid" src="assets/images/icons/mitech-home-resolutions-box-image-01-100x98.webp" alt=""/>
                                                    </div>
                                                    <div className="hover-images">
                                                        <img className="img-fulid" src="assets/images/icons/mitech-home-resolutions-box-image-01-hover-100x98.webp" alt=""/>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="col-lg-4 col-md-6 wow move-up">
                                        ...
                                        <div className="ht-box-images style-05">
                                            <div className="image-box-wrap">
                                                <div className="box-image">
                                                    <div className="default-image">
                                                        <img className="img-fulid" src="assets/images/icons/mitech-home-resolutions-box-image-02-100x98.webp" alt=""/>
                                                    </div>
                                                    <div className="hover-images">
                                                        <img className="img-fulid" src="assets/images/icons/mitech-home-resolutions-box-image-02-hover-100x98.webp" alt=""/>
                                                    </div>
                                                </div>
                                                <div className="content">
                                    ...
                                    <div className="col-lg-4 col-md-6 wow move-up">
                                        ...
                                        <div className="ht-box-images style-05">
                                            <div className="image-box-wrap">
                                                <div className="box-image">
                                                    <div className="default-image">
                                                        <img className="img-fulid" src="assets/images/icons/mitech-home-resolutions-box-image-03-100x98.webp" alt=""/>
                                                    </div>
                                                    <div className="hover-images">
                                                        <img className="img-fulid" src="assets/images/icons/mitech-home-resolutions-box-image-03-hover-100x98.webp" alt=""/>
                                                    </div>
                                                </div>
                                                <div className="content">
                            ...
                            <div className="section-under-heading text-center section-space--mt_80">Challenges are just opportunities in disguise. <a  >Take the challenge!</a></div>
                                ...
                                <div className="row">
                                    <div className="col-lg-3 col-md-6 wow move-up">
                                        ...
                                        <div className="ht-box-icon style-01 single-svg-icon-box">
                                            <div className="icon-box-wrap">
                                                <div className="icon">
                                                    <div className="svg-icon" id="svg-icon-1" data-svg-icon="assets/images/svg/linea-basic-heart.svg"></div>
                                                </div>
                                                <div className="content">
                                                    <h5 className="heading">IT Design </h5>
                                                    <div className="text">We provide the most responsive and functional IT design for companies and businesses worldwide.
                                    ...
                                    <div className="col-lg-3 col-md-6 wow move-up">
                                        ...
                                        <div className="ht-box-icon style-01 single-svg-icon-box">
                                            <div className="icon-box-wrap">
                                                <div className="icon">
                                                    <div className="svg-icon" id="svg-icon-2" data-svg-icon="assets/images/svg/linea-basic-case.svg"></div>
                                                </div>
                                                <div className="content">
                                                    <h5 className="heading">IT Management</h5>
                                                    <div className="text">It’s possible to simultaneously manage and transform information from one server to another.
                                    ...
                                    <div className="col-lg-3 col-md-6 wow move-up">
                                        ...
                                        <div className="ht-box-icon style-01 single-svg-icon-box">
                                            <div className="icon-box-wrap">
                                                <div className="icon">
                                                    <div className="svg-icon" id="svg-icon-3" data-svg-icon="assets/images/svg/linea-basic-alarm.svg"></div>
                                                </div>
                                                <div className="content">
                                                    <h5 className="heading">Data Security</h5>
                                                    <div className="text">We provide the most responsive and functional IT design for companies and businesses worldwide.
                                    ...
                                    <div className="col-lg-3 col-md-6 wow move-up">
                                        ...
                                        <div className="ht-box-icon style-01 single-svg-icon-box">
                                            <div className="icon-box-wrap">
                                                <div className="icon">
                                                    <div className="svg-icon" id="svg-icon-4" data-svg-icon="assets/images/svg/linea-basic-geolocalize-05.svg"></div>
                                                </div>
                                                <div className="content">
                                    ...
                                    <div className="col-lg-3 col-md-6 wow move-up">
                                        ...
                                        <div className="ht-box-icon style-01 single-svg-icon-box">
                                            <div className="icon-box-wrap">
                                                <div className="icon">
                                                    <div className="svg-icon" id="svg-icon-5" data-svg-icon="assets/images/svg/linea-ecommerce-money.svg"></div>
                                                </div>
                                                <div className="content">
                                    ...
                                    <div className="col-lg-3 col-md-6 wow move-up">
                                        ...
                                        <div className="ht-box-icon style-01 single-svg-icon-box">
                                            <div className="icon-box-wrap">
                                                <div className="icon">
                                                    <div className="svg-icon" id="svg-icon-6" data-svg-icon="assets/images/svg/linea-basic-spread-text-bookmark.svg"></div>
                                                </div>
                                                <div className="content">
                                    ...
                                    <div className="col-lg-3 col-md-6 wow move-up">
                                        ...
                                        <div className="ht-box-icon style-01 single-svg-icon-box">
                                            <div className="icon-box-wrap">
                                                <div className="icon">
                                                    <div className="svg-icon" id="svg-icon-7" data-svg-icon="assets/images/svg/linea-music-headphones.svg"></div>
                                                </div>
                                                <div className="content">
                                    ...
                                    <div className="col-lg-3 col-md-6 wow move-up">
                                        ...
                                        <div className="ht-box-icon style-01 single-svg-icon-box">
                                            <div className="icon-box-wrap">
                                                <div className="icon">
                                                    <div className="svg-icon" id="svg-icon-8" data-svg-icon="assets/images/svg/linea-basic-gear.svg"></div>
                                                </div>
                                                <div className="content">

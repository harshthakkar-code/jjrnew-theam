                        ...
                        <div className="col-lg-12 col-md-12 m-auto">
                            <div className="service-hero-wrap wow move-up">
                                <div className="service-hero-text text-center">
                                    ...
                                    <div className="service-solution-form-wrap me-auto ms-auto">
                        ...
                        <div className="row">
                                ...
                                <div className="single-blog-lg-item wow move-up">
                                    ...
                                    <a href="blog-post-layout-one.html">
                                        <div className="post-blog-thumbnail">
                                            <img className="img-fluid" src="assets/images/blog/blog-03-540x330.webp" alt="Blog Images"/>
                                            <div className="post-meta mt-20">
                                                <div className="post-author">
                                                    <img className="img-fluid avatar-96" src="assets/images/team/admin.webp" alt=""/> Harry Ferguson
                                                </div>
                            ...
                            <div className="col-lg-6 blog-list-service">
                                <div className="single-blog-lg-list wow move-up">
                                    ...
                                    <a href="blog-post-layout-one.html">
                                        <div className="post-blog-thumbnail">
                                            <img className="img-fluid" src="assets/images/blog/blog-01-480x312.webp" alt="Blog Images"/>
                                            <div className="post-meta mt-20">
                                                <div className="post-author">
                                                    <img className="img-fluid avatar-96" src="assets/images/team/admin.webp" alt=""/> Harry Ferguson
                                                </div>
                                ...
                                <div className="single-blog-lg-list wow move-up">
                                    ...
                                    <a href="blog-post-layout-one.html">
                                        <div className="post-blog-thumbnail">
                                            <img className="img-fluid" src="assets/images/blog/blog-08-480x312.webp" alt="Blog Images"/>
                                            <div className="post-meta mt-20">
                                                <div className="post-author">
                                                    <img className="img-fluid avatar-96" src="assets/images/team/admin-02.webp" alt=""/> Harry Ferguson
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div className="single-blog-lg-list wow move-up">
                                    ...
                                    <a href="blog-post-layout-one.html">
                                        <div className="post-blog-thumbnail">
                                            <img className="img-fluid" src="assets/images/blog/blog-07-480x312.webp" alt="Blog Images"/>
                                            <div className="post-meta mt-20">
                                                <div className="post-author">
                                                    <img className="img-fluid avatar-96" src="assets/images/team/admin-02.webp" alt=""/> Harry Ferguson
                                                </div>

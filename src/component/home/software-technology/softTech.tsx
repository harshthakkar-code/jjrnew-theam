...
<div className="site-wrapper-reveal">
                ...
                <div className="col-lg-6 col-md-6">
                    <div className="infotechno-hero-inner-images">
                        ...
                        <div className="infotechno-inner-two  wow move-up">
                            <img className="img-fluid" src="assets/images/hero/home-infotechno-main-slider-slide-01-image-02.webp" alt=""/>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div className="box-large-image__box">
                                        <div className="box-large-image__midea">
                                            <div className="images-midea">
                                                <img src="assets/images/box-image/blog-01-330x330.webp" width="330" height="330" className="img-fluid" alt=""/>
                            ...
                            <div className="col-lg-4 col-md-6  mt-30">
                                ...
                                <a href="#" className="box-large-image__wrap wow move-up">
                                    <div className="box-large-image__box">
                                        <div className="box-large-image__midea">
                                            <div className="images-midea">
                                                <img src="assets/images/box-image/mitech-home-infotechno-box-large-image-02-330x330.webp" width="330" height="330" className="img-fluid" alt=""/>
                            ...
                            <div className="col-lg-4 col-md-6  mt-30">
                                ...
                                <a href="#" className="box-large-image__wrap wow move-up">
                                    <div className="box-large-image__box">
                                        <div className="box-large-image__midea">
                                            <div className="images-midea">
                                                <img src="assets/images/box-image/mitech-home-infotechno-box-large-image-03-330x330.webp" width="330" height="330" className="img-fluid" alt=""/>
    ...
    <div className="infotechno-video-wrapper infotechno-video-ptb infotechno-video-bg">
        <div className="container">
            <div className="row">
                                    ...
                                    <div className="testimonial-slider__single wow move-up">
                                        ...
                                        <div className="author-info">
                                            ...
                                            <div className="testimonial-slider__author">
                                                <h6 className="name">Maggie Strickland</h6>
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-slider__single wow move-up">
                                        ...
                                        <div className="author-info">
                                            ...
                                            <div className="testimonial-slider__author">
                                                <h6 className="name">Robert Amplilian</h6>
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-slider__single wow move-up">
                                        ...
                                        <div className="author-info">
                                            ...
                                            <div className="testimonial-slider__author">
                                                <h6 className="name">Stephen Mearsley</h6>
                                                <span className="designation">PR Officer</span>
                                            </div>
                                        </div>

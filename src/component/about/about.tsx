...
const About: React.FC = () => { 
    return(
        ...
        <div className="site-wrapper-reveal">
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            ...
                            <div className="section-title-wrap text-center section-space--mb_60">
                                ...
                                <h3 className="heading">Share the joy of achieving <span className="text-color-primary"> glorious   <br /> moments</span> & climbed up <span className="text-color-primary">the top.</span></h3>
                            </div>
                            {/* <!-- section-title-wrap Start --> */}
                        </div>
                    </div>
            ...
            {/* <!--===========  feature-large-images-wrapper  Start =============--> */}
            <div className="feature-large-images-wrapper bg-gray section-space--ptb_100">
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            ...
                            <div className="section-title-wrap text-center section-space--mb_30">
                                ...
                                <h3 className="heading">How we claim to<span className="text-color-primary">  excel?</span></h3>
                            </div>
                            {/* <!-- section-title-wrap Start --> */}
                        </div>
                    </div>
                                        ...
                                        <div className="box-large-image__box">
                                            <div className="box-large-image__midea">
                                                <div className="images-midea">
                                                    <img src="assets/images/box-image/blog-01-330x330.webp" className="img-fluid" alt="" />
                                ...
                                <div className="col-lg-4 col-md-6  mt-30">
                                    ...
                                    <a   className="box-large-image__wrap wow move-up">
                                        <div className="box-large-image__box">
                                            <div className="box-large-image__midea">
                                                <div className="images-midea">
                                                    <img src="assets/images/box-image/mitech-home-infotechno-box-large-image-02-330x330.webp" className="img-fluid" alt="" />
                                ...
                                <div className="col-lg-4 col-md-6  mt-30">
                                    ...
                                    <a   className="box-large-image__wrap wow move-up">
                                        <div className="box-large-image__box">
                                            <div className="box-large-image__midea">
                                                <div className="images-midea">
                                                    <img src="assets/images/box-image/mitech-home-infotechno-box-large-image-03-330x330.webp" className="img-fluid" alt="" />
            ...
            <div className="gallery-section section-space--pt_100">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                ...
                                <div className="gallery-warp popup-images ">
                                    ...
                                    <a className="single-gallery gallery-grid wow move-up" href="assets/images/gallery/blog-07-960x960.webp">
                                        <div className="single-gallery__item">
                                            <div className="single-gallery__thum bg-item-images bg-img" data-bg="assets/images/gallery/blog-07-960x960.webp">
                                    ...
                                    {/* <!-- single gallery End --> */}
                                    {/* <!-- single gallery Start --> */}
                                    <a className="single-gallery gallery-grid wow move-up" href="assets/images/gallery/careers-gallery-image-01-960x960.webp">
                                        <div className="single-gallery__item">
                                            <div className="single-gallery__thum bg-item-images bg-img" data-bg="assets/images/gallery/careers-gallery-image-01-960x960.webp"></div>
                                            <div className="ht-overlay"></div>
                                            <div className="overlay-icon">
                                                <i className="fas fa-search"></i>
                                            </div>
                                    ...
                                    {/* <!-- single gallery End --> */}
                                    {/* <!-- single gallery Start --> */}
                                    <a className="single-gallery gallery-grid wow move-up" href="assets/images/gallery/blog-08-960x960.webp">
                                        <div className="single-gallery__item">
                                            <div className="single-gallery__thum bg-item-images bg-img" data-bg="assets/images/gallery/blog-08-960x960.webp"></div>
                                            <div className="ht-overlay"></div>
                                            <div className="overlay-icon">
                                                <i className="fas fa-search"></i>
                                            </div>
                                    ...
                                    {/* <!-- single gallery End --> */}
                                    {/* <!-- single gallery Start --> */}
                                    <a className="single-gallery gallery-grid wow move-up" href="assets/images/gallery/blog-06-960x960.webp">
                                        <div className="single-gallery__item">
                                            <div className="single-gallery__thum bg-item-images bg-img" data-bg="assets/images/gallery/blog-06-960x960.webp"></div>
                                            <div className="ht-overlay"></div>
                                            <div className="overlay-icon">
                                                <i className="fas fa-search"></i>
                                            </div>
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="contact-form-wrap">
                                ...
                                <form className="contact-form" id="contact-form" action="https://htmldemo.net/mitech/assets/php/services-mail.php" method="post">

                                ...
                                <div className="list">
                                    ...
                                    <div className="item">
                                        <div className="row">
                                            ...
                                            <div className="col-md-6">
                                                <div className="job-description">The Mitech IT team believes in full transparency, being flexible, reliable and being great team players. We are problem solvers, always ready to help and support each other and the organization. </div>
                                            </div>
                                    ...
                                    <div className="item">
                                        <div className="row">
                                            ...
                                            <div className="col-md-6">
                                                <div className="job-description">Mitech is looking for a summer intern to work in the Information &amp; Technology Services area. This position is part of a team which supports Microsoft Server Operating Systems, storage systems, and Client device technologies.</div>
                                            </div>

            ...
            <div className="row">
                <div className="col-12">
                    <div className="breadcrumb_box text-center">
                        <h2 className="breadcrumb-title">Leadership</h2>
        ...
        <div className="site-wrapper-reveal">
            ...
            <div className="team-member-wrapper section-space--pt_100 section-space--pb_70">
                <div className="container">
                    ...
                    <div className="row ht-team-member-style-three">

                        <div className="col-lg-3 col-md-6 wow move-up">
                            <div className="grid-item mb-30">
                                <div className="ht-team-member">
                                    <div className="team-image">
                                    ...
                                    <div className="team-info text-center">
                                        <h6 className="name">Stephany Mearsley </h6>
                                        <div className="position">Marketing</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-3 col-md-6 wow move-up">
                            <div className="grid-item mb-30">
                                <div className="ht-team-member">
                                    ...
                                    <div className="team-info text-center">
                                        <h6 className="name">Dollie Horton </h6>
                                        <div className="position">Marketing</div>
                                    </div>
                                </div>
                            </div>
